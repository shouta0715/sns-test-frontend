...
export const RegisterAuth = () => {
  ...
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center bg-gray-100 p-4">
      ...
      <div className="mt-24 flex w-full max-w-[80%] flex-col space-y-8 rounded border border-blue-500 bg-white p-8 drop-shadow-md  md:w-1/2 md:max-w-none md:p-16">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full rounded-full bg-blue-400 p-2 text-center text-xl font-bold text-white transition-all hover:bg-blue-500 md:py-4"
          >
            {registerUser.data || registerUser.isLoading ? "登録中..." : "登録"}
          </button>
          <div className="flex w-full  cursor-pointer items-center justify-center space-x-16 text-xs text-blue-300 md:text-base">
            <Link href="/">
              <span>ログインはこちら</span>
            </Link>
          </div>
